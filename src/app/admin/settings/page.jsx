          ...
          <TabsContent value="general" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Basic store configuration and contact information
                </CardDescription>
              </CardHeader>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setSettings({ ...settings, roundedCorners: value })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          decimalPlaces: Number.parseInt(e.target.value),
                        })
                      }
                    />
                  </div>
              ...
              <CardContent className="space-y-6">
                ...
                {settings.shippingEnabled && (
                  <>
                        ...
                        {[
                          ...
                          >
                            <input
                              type="checkbox"
                              id={`shipping-${method}`}
                              checked={settings.shippingMethods.includes(
                                method,
                              )}
                              onChange={(e) => {
                                const updatedMethods = e.target.checked
                                  ? [...settings.shippingMethods, method]
                                  : settings.shippingMethods.filter(
                                      (m) => m !== method,
                                    );
                                setSettings({
                                  ...settings,
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            setSettings({ ...settings, shippingOrigin: value })
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="shippingCalculation">
          ...
          <TabsContent value="products" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure product catalog and inventory settings
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          productsPerPage: Number.parseInt(e.target.value),
                        })
                      }
                    />
                  </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setSettings({ ...settings, inventoryTracking: checked })
                    }
                  />
                </div>
                <Separator />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setSettings({ ...settings, showStockLevel: checked })
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">
                      Manually approve reviews before publishing
                    </p>
                  </div>
                  <Switch
                    checked={settings.reviewApproval}
                    onCheckedChange={(checked) =>
                      setSettings({ ...settings, reviewApproval: checked })
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setSettings({ ...settings, relatedProducts: checked })
                    }
                  />
                </div>
                <Separator />
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setSettings({ ...settings, recentlyViewed: checked })
                    }
                  />
                </div>
              </CardContent>
          ...
          <TabsContent value="checkout" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure checkout process and options
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setSettings({ ...settings, guestCheckout: checked })
                    }
                  />
                </div>
                <Separator />
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">
                      Always require a shipping address
                    </p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">
                      Always require a billing address
                    </p>
                  </div>
                  <Switch
                    checked={settings.requireBilling}
                    onCheckedChange={(checked) =>
                      setSettings({ ...settings, requireBilling: checked })
                    }
                  />
                </div>
                <Separator />
