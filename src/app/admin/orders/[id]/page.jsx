...
export default function OrderDetailPage() {
  ...
  const getPaymentIcon = (method) => {
    switch (method.toLowerCase()) {
      ...
      case "mastercard":
        return (
          <div className="w-8 h-5 bg-orange-600 rounded-sm flex items-center justify-center">
      ...
      default:
        return (
          <CreditCard className="w-5 h-5 text-gray-500 dark:text-gray-200" />
        );
    }
  };
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {order.items.map((item) => (
                        <div
                          key={item.id}
                          className="flex items-center space-x-4 p-4 border border-gray-300 dark:border-gray-700 rounded-lg"
                        >
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      <Avatar>
                        <AvatarImage
                          src={
                            order.customer?.avatar || "/placeholder-avatar.jpg"
                          }
                        />
                        <AvatarFallback>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500  dark:text-gray-200">
                        The order was successfully delivered to the customer
                      </p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-200">
                        Package is out for delivery with carrier
                      </p>
                      <p className="text-xs text-gray-400 mt-1">
                        {new Date(
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-200">
                        Order is being processed in the warehouse
                      </p>
                      <p className="text-xs text-gray-400 mt-1">
                        {new Date(
