    ...
    >
      ...
      <div className="relative px-0 flex-1 overflow-hidden">
        ...
        {product.fastDelivery && (
          <Badge
            variant="outline"
            className="absolute top-12 left-3 bg-background/90 backdrop-blur-sm text-xs shadow-md"
          >
        ...
        {(place === "productListing" || place === "featured") &&
          product.location && (
            <Badge
              variant="outline"
              className="absolute bottom-3 left-3 bg-background/90 backdrop-blur-sm text-xs shadow-md"
            >
