                ...
                <Card className="shadow-xl dark:border dark:border-gray-800 dark:bg-gray-800  ">
                    <CardContent className="space-y-10">
                        <div className="text-center ">
                            ...
                            <h2 className="text-2xl font-bold dark:text-primary-foreground ">SignIn with Email</h2>
                            <p className="dark:text-primary-foreground mt-2">Enter your credentials to continue</p>
                        </div>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <Link href="#" className="flex justify-end text-sm hover:text-primary">Forgot Password?</Link>
