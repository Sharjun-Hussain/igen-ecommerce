...
const socialLinks = [
  {
    ...
    logo: "/static/twitter.png",
  },
  {
    name: "facebook",
    color: "hover:text-blue-600",
    logo: "/static/facebook.png",
  },
  {
    name: "instagram",
...
const Footer = () => {
  ...
  return (
    <footer
      ref={footerRef}
      className="w-full bg-background dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-300 relative overflow-hidden border-t border-gray-200 dark:border-gray-800"
    >
      {/* Decorative background blobs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className={`absolute -bottom-32 -right-32 w-64 h-64 rounded-full ${theme === "dark" ? "bg-blue-900/10" : "bg-blue-200/20"}`}
        ></div>
        <div
          className={`absolute -top-32 -left-32 w-64 h-64 rounded-full ${theme === "dark" ? "bg-purple-900/10" : "bg-purple-200/20"}`}
        ></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed max-w-md">
              Your ultimate destination for the latest mobiles, accessories, and
              gadgets. We offer top brands, best deals, and exceptional service.
            </p>
              ...
              <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                {section.links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="footer-link hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300 flex items-center"
                    >
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-md">
                Subscribe to receive exclusive offers, product updates, and tech
                tips.
              </p>
            </div>
            <form
            ...
            >
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium py-4 px-8 rounded-r-lg transition-all duration-300 shadow-md hover:shadow-lg"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {Object.entries(paymentMethodLogos).map(
              ([methodName, imagePath]) => (
                <div
                  key={methodName}
        ...
        <div className="copyright-animate border-t border-gray-200 dark:border-gray-800 pt-8 text-center text-gray-600 dark:text-gray-400">
          <p className="mb-4">
            &copy; {new Date().getFullYear()} igen. All rights reserved.
          </p>
